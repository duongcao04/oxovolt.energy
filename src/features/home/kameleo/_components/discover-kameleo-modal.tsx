...
export function DiscoverKameleoModal({
    isOpen,
    onOpenChange,
    onDiscover,
}: {
                            ...
                            <div className="grid w-full flex-1 grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-10">
                                ...
                                <div className="flex flex-col justify-center">
                                    ...
                                    <div className="mb-10 flex flex-col gap-4">
                                        {[
                                            t(
                                                'kameleo.discover.features.1',
                                                'Retrofit & hybrid compatible',
                                            ),
                                            t(
                                                'kameleo.discover.features.2',
                                                'Modular & scalable',
                                            ),
                                            t(
                                                'kameleo.discover.features.3',
                                                'Quick integration',
                                            ),
                                            t(
                                                'kameleo.discover.features.4',
                                    ...
                                    <Button
                                        ...
                                        onPress={onDiscover}
                                    >
                                        {t('home.solutions.kameleo.button')}
                                    </Button>
                                </div>
