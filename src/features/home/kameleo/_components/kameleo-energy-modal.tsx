...
export function KameleoEnergyModal({
    isOpen,
    onOpenChange,
    onDiscoverSeries,
}: {
    ...
    const footerContent = (
        <div className="flex w-full flex-col items-center justify-between gap-6 rounded-2xl border border-zinc-200 bg-background p-4 shadow-sm lg:flex-row lg:gap-0 lg:p-6">
            ...
            <div className="grid w-full grid-cols-2 gap-4 px-0 lg:flex lg:flex-1 lg:items-center lg:justify-between lg:gap-0 lg:px-6">
                {[
                    {
                        title: t('kameleo.energy.footer.always_on.title'),
                        desc: t('kameleo.energy.footer.always_on.desc'),
                    },
                    {
                        title: t('kameleo.energy.footer.instant.title'),
                        desc: t('kameleo.energy.footer.instant.desc'),
                    },
                    {
                        title: t('kameleo.energy.footer.dependable.title'),
                        desc: t('kameleo.energy.footer.dependable.desc'),
                    },
                    {
                        title: t('kameleo.energy.footer.peace_of_mind.title'),
                        desc: t('kameleo.energy.footer.peace_of_mind.desc'),
                    },
                ].map((item, idx) => (
                    <div
                        key={idx}
                                ...
                                <div className="col-span-12 flex flex-col justify-start lg:col-span-5">
                                    ...
                                    <div className="relative mt-8 flex items-center justify-center">
                                        <Image
                                            ...
                                            className="relative z-10 w-full cursor-zoom-in object-contain lg:max-w-[280px] lg:max-w-[420px]"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="col-span-12 flex flex-col justify-start lg:col-span-7">
                                    <div>
                                        <h3 className="text-2xl font-bold text-zinc-900">
                                            {t('kameleo.energy.continuity')}
                                        </h3>
                                        <h3 className="mb-8 text-2xl font-bold text-blue-700">
                                            {t(
                                                'kameleo.energy.power_never_stops',
                                            )}
                                        </h3>
                                        ...
                                        <div className="flex flex-col gap-6">
                                            {[
                                                {
                                                    title: t(
                                                        'kameleo.energy.features.uninterrupted.title',
                                                    ),
                                                    desc: t(
                                                        'kameleo.energy.features.uninterrupted.desc',
                                                    ),
                                                },
                                                {
                                                    title: t(
                                                        'kameleo.energy.features.automatic.title',
                                                    ),
                                                    desc: t(
                                                        'kameleo.energy.features.automatic.desc',
                                                    ),
                                                },
                                                {
                                                    title: t(
                                                        'kameleo.energy.features.reliable.title',
                                                    ),
                                                    desc: t(
                                                        'kameleo.energy.features.reliable.desc',
                                                    ),
                                                },
                                                {
                                                    title: t(
                                                        'kameleo.energy.features.built_for.title',
                                                    ),
                                                    desc: t(
                                                        'kameleo.energy.features.built_for.desc',
                                                    ),
                                                },
                                            ].map((item, idx) => (
                                                <div
                                        ...
                                        <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
                                            <div className="flex-1">
                                                <h4 className="text-lg leading-tight font-bold whitespace-pre-line text-zinc-900">
                                                    {t(
                                                        'kameleo.energy.protection.title',
                                                    )}
                                                </h4>
                                                <p className="mt-2 text-sm font-bold text-blue-700">
                                                    {t(
                                                        'kameleo.energy.protection.subtitle',
                                                    )}
                                                </p>
                                            </div>
                                            ...
                                            <div className="flex flex-col gap-4 lg:flex-[1.5] lg:flex-row">
                                                {[
                                                    {
                                                        title: t(
                                                            'kameleo.energy.protection.home.title',
                                                        ),
                                                        desc: t(
                                                            'kameleo.energy.protection.home.desc',
                                                        ),
                                                    },
                                                    {
                                                        title: t(
                                                            'kameleo.energy.protection.business.title',
                                                        ),
                                                        desc: t(
                                                            'kameleo.energy.protection.business.desc',
                                                        ),
                                                    },
                                                    {
                                                        title: t(
                                                            'kameleo.energy.protection.infrastructure.title',
                                                        ),
                                                        desc: t(
                                                            'kameleo.energy.protection.infrastructure.desc',
                                                        ),
                                                    },
                                                ].map((item, idx) => (
                                                    <div
