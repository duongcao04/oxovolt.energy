...
export function LoopXcellEnergyContinuityModal({
    isOpen,
    onOpenChange,
    onCTAClick,
    onSecondaryClick,
    ...
    const featuresLeft = t('home.modals.energy.features_left', {
        returnObjects: true,
    }) as { title: string; desc: string }[];
    const featuresRight = t('home.modals.energy.features_right', {
        returnObjects: true,
    }) as { title: string; desc: string }[];
    const bottomGrid = t('home.modals.energy.bottom_grid', {
        returnObjects: true,
    }) as { title: string; desc: string }[];
    const footerStats = t('home.modals.energy.footer_stats', {
        returnObjects: true,
    }) as { val: string; label: string }[];
    const cardTitle = t('home.modals.energy.card_title', {
        returnObjects: true,
    }) as string[];
    const cloudList1 = t('home.modals.energy.cloud.list1', {
        returnObjects: true,
    }) as string[];
    const cloudList2 = t('home.modals.energy.cloud.list2', {
        returnObjects: true,
    }) as string[];
        ...
        <div className="flex w-full flex-col items-center justify-between gap-4 border-t border-zinc-200 bg-[#F5F7FA] px-4 py-4 lg:flex-row lg:gap-6 lg:px-10 lg:py-6">
            ...
            <div className="flex w-full items-center gap-4 lg:w-[280px]">
                ...
                <div>
                    <h4 className="mb-0.5 text-[10px] font-bold tracking-wider whitespace-pre-line text-zinc-900 uppercase">
                        {t('home.modals.energy.footer_left_title')}
                    </h4>
                    <p className="text-[10px] leading-snug whitespace-pre-line text-zinc-600">
                        {t('home.modals.energy.footer_left_desc')}
                    </p>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center lg:border-l lg:border-zinc-200 lg:pr-4 lg:pl-6">
                ...
                <span className="text-[8px] font-bold tracking-wider text-zinc-900 uppercase">
                    {t('home.modals.energy.footer_belgium')}
                </span>
            </div>
            ...
            <div className="flex w-full flex-col gap-2 lg:ml-auto lg:w-[240px]">
                <button
                    ...
                    onClick={onCTAClick}
                >
                    <span>{t('home.modals.energy.footer_btn1')}</span>
                    <ArrowRight size={14} />
                </button>
                <button
                ...
                >
                    <span>{t('home.modals.energy.footer_btn2')}</span>
                    <ArrowRight size={14} />
                </button>
            </div>
        </div>
                            ...
                            <div className="grid w-full flex-1 grid-cols-12 gap-6 px-4 pb-4 font-sans lg:gap-10 lg:px-10 lg:pb-10">
                                ...
                                <div className="relative col-span-12 flex items-center justify-center lg:col-span-4">
                                    ...
                                    <Image
                                        ...
                                        className="relative z-10 w-full max-w-[240px] cursor-zoom-in object-contain mix-blend-multiply drop-shadow-2xl lg:max-w-[380px]"
                                        preview={{
                                            getContainer: () =>
                                ...
                                <div className="col-span-12 flex flex-col justify-center gap-8 lg:col-span-5">
                                    ...
                                    <div>
                                        <h3 className="mb-6 text-xl font-bold">
                                            <span className="text-zinc-900">
                                                {t(
                                                    'home.modals.energy.features_right_title_main',
                                                )}
                                            </span>
                                            <br />
                                            <span className="text-blue-700">
                                                {t(
                                                    'home.modals.energy.features_right_title_highlight',
                                                )}
                                            </span>
                                        </h3>
                                    ...
                                    <div className="mt-2 rounded-2xl border border-zinc-100 bg-background p-6 shadow-sm">
                                        ...
                                        <p className="mb-6 text-[11px] text-zinc-600">
                                            {t('home.modals.energy.card_desc')}
                                        </p>
                                        ...
                                        <div className="mb-6 flex flex-col items-center gap-6 lg:flex-row lg:gap-4">
                                            <div className="w-full flex-1 text-center lg:text-left">
                                                <h5 className="mb-2 text-[9px] font-bold tracking-wider text-blue-700">
                                                    {t(
                                                        'home.modals.energy.cloud.title1',
                                                    )}
                                                </h5>
                                                <p className="mb-3 text-[10px] leading-snug text-zinc-600">
                                                    {t(
                                                        'home.modals.energy.cloud.desc1',
                                                    )}
                                                </p>
                                            ...
                                            <div className="w-full flex-1 text-center lg:text-left">
                                                <h5 className="mb-2 text-[9px] font-bold tracking-wider text-blue-700">
                                                    {t(
                                                        'home.modals.energy.cloud.title2',
                                                    )}
                                                </h5>
                                                <p className="mb-3 text-[10px] leading-snug text-zinc-600">
                                                    {t(
                                                        'home.modals.energy.cloud.desc2',
                                                    )}
                                                </p>
                                                <ul className="inline-block space-y-1 text-left lg:block">
                                                    {cloudList2.map(
