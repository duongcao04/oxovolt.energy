...
type EnergyContinuityModalProps = {
    isOpen: boolean;
    onOpenChange: (state: boolean) => void;
};

export const EnergyContinuityModal = ({
    isOpen,
    onOpenChange,
}: EnergyContinuityModalProps) => {
    const { t } = useTranslation();
    const { isSmallView } = useDevice();

    const features = t('home.hero.modal.energy.features', {
        returnObjects: true,
