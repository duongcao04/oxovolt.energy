...
export const FieldNotes = ({ onBack }: { onBack: () => void }) => {
    return (
        <PageLayout title="Field Notes" onBack={onBack}>
            <PageSection subtitle="Deployments" link="press@oxovolt.com">
            ...
            <PageSection subtitle="Operational Learnings" link="press@oxovolt.com">
            ...
            <PageSection subtitle="Infrastructure Feedback" link="press@oxovolt.com">
            ...
            <PageSection subtitle="Real Environments" link="press@oxovolt.com">
