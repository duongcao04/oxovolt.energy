...
export const TechnicalBlog = ({ onBack }: { onBack: () => void }) => {
    return (
        <PageLayout title="Technical Blog" onBack={onBack}>
            <PageSection subtitle="Architecture Breakdowns" link="knowledge@oxovolt.com">
            ...
            <PageSection subtitle="Engineering Articles" link="knowledge@oxovolt.com">
            ...
            <PageSection subtitle="Technology Insights" link="knowledge@oxovolt.com">
            ...
            <PageSection subtitle="System Intelligence" link="knowledge@oxovolt.com">
