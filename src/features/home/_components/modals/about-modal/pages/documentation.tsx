...
export const Documentation = ({ onBack }: { onBack: () => void }) => {
    return (
        <PageLayout title="Documentation" onBack={onBack}>
            <PageSection subtitle="Technical Manuals" link="knowledge@amoovo.com">
            ...
            <PageSection subtitle="Integration Guides" link="knowledge@amoovo.com">
            ...
            <PageSection subtitle="Whitepapers" link="knowledge@amoovo.com">
            ...
            <PageSection subtitle="Operational Resources" link="knowledge@amoovo.com">
