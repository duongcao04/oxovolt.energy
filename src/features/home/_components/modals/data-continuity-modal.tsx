...
type DataContinuityModalProps = {
    isOpen: boolean;
    onOpenChange: (state: boolean) => void;
};

export const DataContinuityModal = ({
    isOpen,
    onOpenChange,
}: DataContinuityModalProps) => {
    const { t } = useTranslation();
    const { isSmallView } = useDevice();

    const features = t('home.hero.modal.dataVault.features', {
        returnObjects: true,
    }) as { title: string; desc: string }[];
    const tabs = t('home.hero.modal.dataVault.tabs', {
        returnObjects: true,
    }) as string[];
